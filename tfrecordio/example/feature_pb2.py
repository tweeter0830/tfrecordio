...
# source: tfrecordio/example/feature.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tfrecordio/example/feature.proto',
  package='tensorflow',
  syntax='proto3',
...
BytesList = _reflection.GeneratedProtocolMessageType('BytesList', (_message.Message,), dict(
  ...
  __module__ = 'tfrecordio.example.feature_pb2'
